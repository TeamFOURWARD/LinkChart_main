...
public class NetworkUtil {
    /**
     * GET 방식 호출(전송할 헤더값 존재하지 않는 경우 사용)
     *
     ...
     */
    public static String get(URL url, @Nullable Map<String, String> requestHeaders) {
     ...
     * @param requestHeaders 전송하고 싶은 해더 정보
     */
    public static String post(URL url, @Nullable Map<String, String> requestHeaders, String postParams) {
        HttpURLConnection con = connect(url);
    ...
    private static String readBody(InputStream body) {
        ...
        try (BufferedReader lineReader = new BufferedReader(streamReader)) {
            ...
            return responseBody.toString().replaceAll("\\s", "");//공백 삭제
        } catch (IOException e) {
